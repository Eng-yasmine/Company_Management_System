  <script src="{{asset('admin_assets/js/jquery.min.js')}}"></script>
    ...
    <script src="{{asset('admin_assets/js/d3.min.js')}}"></script>
    <script src="{{asset('admin_assets/js/topojson.min.js')}}"></script>
    <script src="{{asset('admin_assets/js/datamaps.all.min.js')}}"></script>
    <script src="{{asset('admin_assets/js/datamaps-zoomto.js')}}"></script>
    <script src="{{asset('admin_assets/js/datamaps.custom.js')}}"></script>
